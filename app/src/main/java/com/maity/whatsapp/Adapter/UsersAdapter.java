...
import com.maity.whatsapp.ChatDetailActivity;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder>{
    ...
    public void onBindViewHolder( UsersAdapter.ViewHolder holder, int position) {
        ...
        Picasso.get().load(users.getProfiledp()).placeholder(R.drawable.whatsapp).into(holder.image);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Profile Picture",users.getProfiledp());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(View itemView) {
            ...
            lastmessage=itemView.findViewById(R.id.textView4);
        }
    }
}
